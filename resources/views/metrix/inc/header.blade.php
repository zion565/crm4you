...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('metrix_file/assets/libs/quill/dist/quill.snow.css')}}">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img width="50%" src="{{ asset('metrix_file/assets/images/favicon.png')}}" alt="logo" />    
                        </b>
                        <!--End Logo icon -->
                         <!-- Logo text -->
                        <span class="logo-text">
                                <span style="color: #28b779">CRM</span>
                                <span style="color: #193f7a">4</span>
                                <span style="color: #ffb848">YOU</span>
                        </span>
                        <!-- Logo icon -->
                        <!-- <b class="logo-icon"> -->
                            <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('metrix_file/assets/images/users/1.jpg')}}" alt="user" class="rounded-circle" width="31"></a>
